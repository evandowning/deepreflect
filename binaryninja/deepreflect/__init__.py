...
from .label import add_label, remove_label
...
PluginCommand.register_for_function("DeepReflect\\Label\\2. Remove Function Label", "Remove function's label", remove_label)
