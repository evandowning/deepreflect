...
combine ()
{
    ...
    python combine.py "${base}/idd_dr_filter_size_func_data.npz" \
                      "${base}/mod_CmdExec_dr_filter_size_func_data.npz" \
                      "${base}/mod_DomainReplication_dr_filter_size_func_data.npz" \
                      "${base}/mod_LogonPasswords_dr_filter_size_func_data.npz" \
                      "${base}/mod_NetworkConnectivity_dr_filter_size_func_data.npz" \
                      "${base}/rse_dr_filter_size_func_data.npz" \
                      "${base}/combined_dr_filter_size_func_data.npz"

    python combine.py "${base}/idd_dr_filter_callee_func_data.npz" \
                      "${base}/mod_CmdExec_dr_filter_callee_func_data.npz" \
                      "${base}/mod_DomainReplication_dr_filter_callee_func_data.npz" \
                      "${base}/mod_LogonPasswords_dr_filter_callee_func_data.npz" \
                      "${base}/mod_NetworkConnectivity_dr_filter_callee_func_data.npz" \
                      "${base}/rse_dr_filter_callee_func_data.npz" \
                      "${base}/combined_dr_filter_callee_func_data.npz"
}
